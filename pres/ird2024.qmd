...
-   BSc on Geography (2007) and Specialization on Statistics (2009)
-   Master's on Public Health (2017). *Spatio-temporal models to study the relationship between traffic violence and income.*
-   Doctorate on Health Information and Communication (Fiocruz, 2021). *Applications of Data Science methods on Public Health.*
-   Final year of a postdoc position at Inria. *Machine Learning methods*.
...
-   *Visualization:* malaria and COVID-19 interactive visualization dashboards (Fiocruz and IRD)
...
-   Challenges on data availability, standardization, and health information communication
...
-   Framework proposal to prevent and early detect CSD outbreaks
