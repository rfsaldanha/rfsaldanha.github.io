...
descrip_exif <- function(x){
  ...
  glue::glue("{exif$Make} {exif$Model} Lente {exif$LensModel} <br>
...
![Flamingo-comum](images/20240211_0325.jpg){description="`r descrip_exif('images/20240211_0325.jpg')`" desc-position="left" group="mejean"}

![Garça-branca-pequena](images/20240211_0044.jpg){description="`r descrip_exif('images/20240211_0044.jpg')`" desc-position="left" group="mejean"}
...
![Cegonha-branca](images/20240211_0504.jpg){description="`r descrip_exif('images/20240211_0504.jpg')`" desc-position="left" group="mejean"}
:::
...
![Praia de seixos negros de Djúpalónssandur](images/20240115_0093.jpg){description="`r descrip_exif('images/20240115_0093.jpg')` " desc-position="left" group="iceland"}
...
![Praia dos Diamantes](images/20240115_0268.jpg){description="`r descrip_exif('images/20240115_0268.jpg')` " desc-position="left" group="iceland"}
