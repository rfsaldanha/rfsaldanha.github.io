...
```{r}
pbundle_2019 <- readRDS("pbundle_2019.rds")
pbundle_2020 <- readRDS("pbundle_2020.rds")
pbundle_2021 <- readRDS("pbundle_2021.rds")
pbundle_2022 <- readRDS("pbundle_2022.rds")
pbundle_2023 <- readRDS("pbundle_2023.rds")
...
ggplot() +
  ...
  labs(title = "Patient's flow for hospital admission, 2020") +
  ggraph::theme_graph(background = "black") +
  theme(plot.title = element_text(color = "white"))
```
...
ggplot() +
  ...
  labs(title = "Patient's flow for hospital admission, 2019") +
  ggraph::theme_graph(background = "black") +
  theme(plot.title = element_text(color = "white"))
```
...
ggplot() +
  ...
  labs(title = "Patient's flow for hospital admission, 2022") +
  ggraph::theme_graph(background = "black") +
  theme(plot.title = element_text(color = "white"))
```
