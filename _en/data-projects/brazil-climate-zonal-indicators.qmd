...
2025: [![](https://img.shields.io/badge/download-10.5281/zenodo.18257037-green.svg)](https://doi.org/10.5281/zenodo.18257037)

Relative humidity (1950 - 2025): [![](https://img.shields.io/badge/download-10.5281/zenodo.18392587-green.svg)](https://doi.org/10.5281/zenodo.18392587)

Wind speed (1950 - 2025): [![](https://img.shields.io/badge/download-10.5281/zenodo.18390794-green.svg)](https://doi.org/10.5281/zenodo.18390794)
...
|--------------------|----------------------------|------------------------|
| Temperature (2m) | mean, max, min | mean, max, min, stdev, count |
| Dewpoint temp. (2m) | mean | mean, max, min, stdev, count |
| $u$ component of wind | mean | mean, max, min, stdev, count |
| $v$ component of wind | mean | mean, max, min, stdev, count |
| Surface pressure | mean | mean, max, min, stdev, count |
| Total precipitation | sum | mean, max, min, stdev, count, sum |
| Relative humidity | mean | mean |
| Wind speed | mean | mean |
